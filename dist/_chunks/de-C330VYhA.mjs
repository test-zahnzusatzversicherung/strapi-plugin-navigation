const e = {
  ...
  popup: {
    navigation: {
      manage: {
        ...
        purge: {
          header: "Diese Aktion leert den API-Lese-Cache. Dadurch können die untenstehenden Navigationen kurzzeitig langsamer gelesen werden."
        },
        delete: {
    ...
    item: {
      ...
      form: {
        title: {
          ...
          placeholder: "Titel des Eintrags eingeben oder leer lassen, um ihn aus dem verknüpften Inhalt zu übernehmen"
        },
        uiRouterKey: {
        ...
        uiRouter: {
          unableToRender: "Slug und/oder UI-Router-Schlüssel können wegen nicht unterstützter Zeichen nicht erstellt werden"
        },
        path: {
          label: "URL",
  ...
  notification: {
    navigation: {
      ...
      error: 'Doppelter Pfad: "{ path }" im übergeordneten Eintrag "{ parentTitle }" für { errorTitles } Einträge',
      item: {
    ...
    settings: {
      ...
      form: {
        ...
        populate: {
          ...
          placeholder: "Mindestens eines auswählen oder leer lassen, um Relationsfelder nicht zu befüllen",
        ...
        pathDefaultFields: {
          ...
          placeholder: "Mindestens eines auswählen oder leer lassen, um die ID als Standardwert zu verwenden",
        ...
        contentTypesSettings: {
          ...
          initializationWarning: {
            title: "Warnung",
            content: "- Content-Type wurde noch nicht initialisiert. Initialisieren Sie ihn zuerst, um ihn im visuellen Editor verwenden zu können."
          }
        },
        customFields: {
          table: {
            confirmation: {
              ...
              message: "Diese Aktion entfernt alle Werte dieses benutzerdefinierten Felds aus Navigationseinträgen.",
              confirm: "Fortfahren",
          ...
          popup: {
            ...
            description: {
              ...
              description: "Diese Beschreibung wird als Hinweis oder Erklärung unter dem Feld angezeigt"
            },
            placeholder: {
      ...
      actions: {
        ...
        restore: {
          ...
          description: "Beim Wiederherstellen wird die Plugin-Konfiguration durch die in 'plugins.js' gespeicherte Konfiguration ersetzt."
        },
        restart: {
          label: "Strapi neu starten",
          alert: {
            title: "Strapi muss neu gestartet werden",
            description: "Sie haben Konfigurationsänderungen vorgenommen, die einen Neustart Ihrer Strapi-Anwendung erfordern. Starten Sie manuell neu oder verwenden Sie die Schaltfläche unten.",
            close: "Verwerfen",
            cancel: "Abbrechen",
            reason: {
        ...
        disableI18n: {
          confirmation: {
            ...
            description: {
              line1: "Sie deaktivieren Internationalisierung für Navigation. Navigationen für andere Sprachen als die Standardsprache können über dieses Plugin nicht mehr angesehen oder geändert werden.",
